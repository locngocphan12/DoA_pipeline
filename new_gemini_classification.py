...
from new_prompt import scientific_aspects_classification_prompt, scientific_argument_system_prompt
...
class GeminiClassifier:
    ...
    def classify_aspect(self, sentence: str, full_review: str) -> str:
        text =f"[FULL REVIEW CONTEXT]: {full_review}\n[LIST OF SENTENCES]: {sentence}"
